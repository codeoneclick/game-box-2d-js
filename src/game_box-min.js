...
oop.define_class({namespace:"gb", name:"common_alert_view", init:function(a, b, c) {
  $(c(a)).append("<div id=" + b.common_alert_view + ' class="ui-state-error ui-corner-all" style="padding: 0 .7em;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span><strong>Warning: </strong><div id=' + b.common_alert_view_textfield + ' style="margin-top: -10.5%; margin-left: 30%;"></div></p></div>');
